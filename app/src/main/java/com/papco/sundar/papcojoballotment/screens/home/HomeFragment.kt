...
import com.papco.sundar.papcojoballotment.screens.monthlyReport.ReportActivity
...
class HomeFragment : Fragment() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return if(item.itemId==R.id.action_monthly_report) {
            launchMonthlyReportActivity()
            true
        }else
            false
    }
    ...
    private fun launchMonthlyReportActivity() {
    ...
    private fun updateMachineDetails(place: Place) {
        ...
        machine_days_count.text = place.duration.daysOfWork()
    }
    ...
    private fun updatePoolDetails(place: Place) {
        ...
        unalloted_days_count.text = place.duration.daysOfWork()
    }
    ...
    private fun updateTotalDetails(place: Place) {
        ...
        total_days_count.text = place.duration.daysOfWork()
    }
